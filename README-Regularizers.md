...
Option 1. Create a new conda environment `regularizers` with the following dependencies.
...
Option 2. Using HIPERGATOR, create a new mamba environment `regularizers` with the following dependencies.

`mamba create -n regularizers'
